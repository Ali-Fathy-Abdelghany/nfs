...
export const fetchDoctorAppointments = (doctorId) => axiosInstance.get(`/api/appointments/doctor/${doctorId}`);
export const fetchDoctorAvailability = (doctorId) => axiosInstance.get(`/api/appointments/availability/${doctorId}`);
export const createAvailabilitySlot = (data) => axiosInstance.post('/api/appointments/availability', data);
export const updateAppointmentStatus = (id, status) => axiosInstance.put(`/api/appointments/${id}/status`, { status });
